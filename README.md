...
Step 2:Move to the Machine Test Updated 

Step 3:Creta abd Activate the Virtaul Environment by (venv\Scripts\activate)

Step 4 : Install the Packages by pip install requiremnts.txt

Step 5 : Create a database updated_db_fastapi

Step 6 : Create a .env file and add the passwrd there DB_PASSWORD = PASSWORD
